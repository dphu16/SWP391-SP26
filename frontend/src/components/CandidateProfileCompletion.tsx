...
const PersonIcon = () => (
 ...
 viewBox="0 0 16 16"
 fill="currentColor"
 className="w-4 h-4 text-text-secondary-light flex-shrink-0"
 >
...
const CredentialsModal: React.FC<CredentialsModalProps> = ({
 ...
 <div className="relative w-full max-w-md bg-surface-light rounded-2xl shadow-lg border border-border-light overflow-hidden animate-scale-in">
 {/* Header gradient */}
 ...
 <div className="flex-1 flex items-center gap-3 bg-gray-50 border border-border-light rounded-xl px-4 py-3">
 <PersonIcon />
 <span className="font-mono text-sm font-semibold text-text-primary-light flex-1 select-all">
 ...
 : "bg-white border-border-light text-text-secondary-light hover:border-primary hover:text-primary"
 }`}
 >
 ...
 <div className="flex-1 flex items-center gap-3 bg-gray-50 border border-border-light rounded-xl px-4 py-3">
 <KeyIcon />
 <span className="font-mono text-sm font-semibold text-text-primary-light flex-1 select-all tracking-wider">
...
const CandidateProfileCompletion: React.FC = () => {
 ...
 <div className="space-y-6">
 {/* ── Breadcrumb ── */}
 <nav className="flex items-center gap-1.5 text-sm text-text-secondary-light ">
 <button
 ...
 <span className="text-text-primary-light font-semibold truncate max-w-xs">
 ...
 <span className="text-xs font-medium text-text-primary-light truncate max-w-[140px]">
 {value || "—"}
 </span>
 </div>
 ))}
 ...
 <div className="rounded-2xl border border-border-light bg-surface-light shadow-card overflow-hidden animate-fade-in">
 {/* Header */}
 <div className="px-4 py-3.5 border-b border-border-light flex items-center gap-2">
 ...
 <span className="ml-auto text-[11px] font-semibold text-text-secondary-light bg-gray-100 px-2 py-0.5 rounded-full">
 ...
 isActive
 ? "font-bold text-text-primary-light "
 : isCompleted
 ? "font-medium text-text-secondary-light line-through decoration-gray-400"
 : "font-medium text-text-primary-light "
 }`}
 >
 {step.title}
 </span>
