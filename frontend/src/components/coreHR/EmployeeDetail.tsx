...
// DTO interface matching GET /api/v1/employees/{employeeId}/dependents
  ...
  if (url) {
    return (
      <img
        src={url}
        alt={name}
        className={`${sizeClass} rounded-full object-cover ring-4 ring-white flex-shrink-0`}
      />
    );
  }
  return (
...
const LocationIcon = () => (
  ...
  >
    <path
      fillRule="evenodd"
      d="M8 1.5a5 5 0 100 10A5 5 0 008 1.5zM0 8a8 8 0 1116 0A8 8 0 010 8zm8-2a2 2 0 100 4 2 2 0 000-4z"
      clipRule="evenodd"
    />
  </svg>
);
...
const BuildingIcon = () => (
  ...
  >
    <path
      fillRule="evenodd"
      d="M1 2.5A1.5 1.5 0 012.5 1h8A1.5 1.5 0 0112 2.5v3.563a3.5 3.5 0 00-1.5-.063V2.5h-8v11h4.5v-1.5a1.5 1.5 0 011.5-1.5h2a1.5 1.5 0 011.5 1.5v1.5h.5a.5.5 0 010 1H2.5A1.5 1.5 0 011 13.5v-11zM3.5 4a.5.5 0 000 1h6a.5.5 0 000-1h-6zm-.5 3.5A.5.5 0 013.5 7h6a.5.5 0 010 1h-6a.5.5 0 01-.5-.5zM3.5 10a.5.5 0 000 1H5a.5.5 0 000-1H3.5z"
      clipRule="evenodd"
    />
...
const EmployeeDetail: React.FC = () => {
  ...
  // Dependent (người phụ thuộc) state
  ...
  // Fetch danh sách người phụ thuộc khi có employeeId
  useEffect(() => {
    if (!id) return;
    ...
    const fetchDependents = async () => {
      try {
        ...
        if (err instanceof Error && "response" in err) {
          // Keep existing behavior silent on dependent fetch errors
  ...
  // Keep existing Emergency Contact UI and only bind fetched data.
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        {editSuccess && (
          <div className="flex items-center gap-2 px-4 py-2 bg-emerald-50 border border-emerald-200 rounded-xl animate-slide-up">
