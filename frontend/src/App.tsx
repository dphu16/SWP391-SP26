    ...
    return (
        <div className="flex h-screen bg-background-light text-text-primary-light font-sans overflow-hidden">
            ...
            <main className="flex-1 flex flex-col h-full overflow-hidden">
                ...
                <div className="flex-1 overflow-hidden bg-background-light flex flex-col">
                    {isAiChat ? (
                        <AIChatBox />
                    ) : (
                        <div className="flex-1 overflow-y-auto px-6 py-6">
                            <div className="max-w-7xl mx-auto space-y-5">
                                <Routes>
                                    ...
                                    {/* Onboarding */}
                                    <Route path="/onboarding" element={<Navigate to="/onboarding/hired" replace />} />
                                    <Route path="/onboarding/hired" element={<HiredApplications />} />
                                    <Route path="/onboarding/progress" element={<EmployeeOnboarding />} />
