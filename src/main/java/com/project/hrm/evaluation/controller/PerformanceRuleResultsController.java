...
public class PerformanceRuleResultsController {
    ...
    @PostMapping
    public ResponseEntity<PerformanceRuleResults> create(@Valid @RequestBody PerformanceRuleResults req){
    ...
    @GetMapping("/{resultId}")
    public ResponseEntity<PerformanceRuleResults> getById(@PathVariable UUID resultId){
        return ResponseEntity.ok(service.getById(resultId));
    }

    @PutMapping("/{resultId}")
    public ResponseEntity<PerformanceRuleResults> update(@PathVariable UUID resultId, @RequestBody PerformanceRuleResults req){
