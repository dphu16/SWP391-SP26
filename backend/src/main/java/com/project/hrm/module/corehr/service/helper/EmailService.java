...
public class EmailService {
    ...
    public void sendPasswordResetEmail(String toEmail, String userName, String token) {
        try {
            ...
            helper.setTo(toEmail);
            helper.setSubject("Reset Your Password - HRM System");
    ...
    public void sendPasswordChangedEmail(String toEmail, String userName) {
        try {
            ...
            helper.setTo(toEmail);
            helper.setSubject("Your Password Has Been Changed - HRM System");
    ...
    private String buildPasswordChangedEmailHtml(String userName) {
        return "<div style=\"font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;\">"
                ...
                + "<p style=\"color: #dc2626; font-size: 14px;\">⚠️ If you did not perform this action, please contact support immediately.</p>"
                + "<hr style=\"border: none; border-top: 1px solid #e5e7eb; margin: 20px 0;\">"
                + "<p style=\"color: #9ca3af; font-size: 12px;\">HRM System - Human Resource Management</p>"
                + "</div>";
    }
