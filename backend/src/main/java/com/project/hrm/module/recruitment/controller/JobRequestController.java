...
public class JobRequestController {
    ...
    public ResponseEntity<List<JobRequestResponse>> getAll() {
        ...
        List<JobRequestResponse> responses = jobRequestService.getAllRequest();
    ...
    public ResponseEntity<List<JobRequestResponse>> getRequestToManager(
        ...
        List<JobRequestResponse> responses = jobRequestService.getRequestByDepartmentId(id);
    ...
    public ResponseEntity<List<JobRequestResponse>> getRequestToHr(
        ...
        List<JobRequestResponse> responses = jobRequestService.getRequestByReportTo(id);
