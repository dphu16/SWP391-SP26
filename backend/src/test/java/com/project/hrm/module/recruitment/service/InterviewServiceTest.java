...
class InterviewServiceTest {
    ...
    void setUp() {
        ...
        hrUser.setRole(EmployeeRole.ROLE_HR);
        ...
        managerUser.setRole(EmployeeRole.ROLE_MANAGER);
    ...
    class InputResult {
        ...
        void inputResult_done_hrRole_appliesWeightedScore() {
            ...
            interviewer.getUser().setRole(EmployeeRole.ROLE_HR);
    ...
    class SendInterviewList {
        ...
        void sendInterviewList_valid_createsManagerInterviews() {
            ...
            when(interviewRepository.existsByApp_IdAndInterviewer_User_Role(
    ...
    class DeleteInterview {
        ...
        @Test
        @DisplayName("Application tồn tại — xóa tất cả interview của app")
        ...
        @Test
        @DisplayName("Application không tồn tại — ném RuntimeException")
        void deleteInterview_applicationNotFound_throwsRuntimeException() {
